...
class NN_WallRecon:
    ...
    RELU_THRESHOLD = -50.0           # Relu threshold for last layer in main network
    ...
    # Dataset definition
    CUR_PATH = '/mimer/NOBACKUP/groups/kthmech/argb/02_VE/n25/04_shear_yp15'
    ## Ret180
